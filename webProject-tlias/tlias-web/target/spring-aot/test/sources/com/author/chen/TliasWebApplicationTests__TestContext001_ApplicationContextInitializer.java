 ...
 */
@Generated
public class TliasWebApplicationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TliasWebApplicationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TliasWebApplicationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
