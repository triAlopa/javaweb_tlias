  ...
  public static class WhitelabelErrorViewConfiguration {
    ...
    private static BeanInstanceSupplier<View> getErrorInstanceSupplier() {
      return BeanInstanceSupplier.<View>forFactoryMethod(ErrorMvcAutoConfiguration.WhitelabelErrorViewConfiguration.class, "defaultErrorView")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.servlet.error.ErrorMvcAutoConfiguration$WhitelabelErrorViewConfiguration", ErrorMvcAutoConfiguration.WhitelabelErrorViewConfiguration.class).defaultErrorView());
    }
    ...
    public static BeanDefinition getErrorBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.servlet.error.ErrorMvcAutoConfiguration$WhitelabelErrorViewConfiguration");
    ...
    private static BeanInstanceSupplier<BeanNameViewResolver> getBeanNameViewResolverInstanceSupplier(
      ...
      return BeanInstanceSupplier.<BeanNameViewResolver>forFactoryMethod(ErrorMvcAutoConfiguration.WhitelabelErrorViewConfiguration.class, "beanNameViewResolver")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.servlet.error.ErrorMvcAutoConfiguration$WhitelabelErrorViewConfiguration", ErrorMvcAutoConfiguration.WhitelabelErrorViewConfiguration.class).beanNameViewResolver());
    }
